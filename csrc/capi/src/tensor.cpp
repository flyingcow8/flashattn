...
Tensor_t make_contiguous_tensor4d(void *data, mcflashattnDataType_t dtype, int batch, int channel, int height,
                                  int width) {
...
Tensor_t make_tensor1d(void *data, mcflashattnDataType_t dtype, int size0, int stride0) {
...
Tensor_t make_tensor2d(void *data, mcflashattnDataType_t dtype, int size0, int size1, int stride0, int stride1) {
...
Tensor_t make_tensor3d(void *data, mcflashattnDataType_t dtype, int size0, int size1, int size2, int stride0,
...
Tensor_t make_tensor4d(void *data, mcflashattnDataType_t dtype, int batch, int channel, int height, int width,
...
Tensor_t make_tensor5d(void *data, mcflashattnDataType_t dtype, int size0, int size1, int size2, int size3, int size4,
                       int stride0, int stride1, int stride2, int stride3, int stride4) {
...
mcflashattnDataType_t get_tensor_dtype(Tensor_t tensor) {
    if (tensor && tensor->data) {
        ...
        switch (dtype) {
            case InternalTensor::DataType::FP16:
                return MCFLASHATTN_DATATYPE_FP16;
            case InternalTensor::DataType::BF16:
                return MCFLASHATTN_DATATYPE_BF16;
            case InternalTensor::DataType::INT8:
                return MCFLASHATTN_DATATYPE_INT8;
            case InternalTensor::DataType::INT32:
                return MCFLASHATTN_DATATYPE_INT32;
            case InternalTensor::DataType::FP32:
                return MCFLASHATTN_DATATYPE_FP32;
            case InternalTensor::DataType::FP64:
