...
inline __device__ void compute_dq_dk_dv_1colblock_hdim64_64x64_4waves(const Params &params, const int bidb,
    ...
    typename Kernel_traits::GmemTiledCopyKV_hdim64 gmem_tiled_copy_KV;
...
#pragma unroll
    ...
    Tensor tdStsdSt =
        make_tensor(make_smem_ptr(dStsmem_ptr_sts), make_layout(Shape<_4, _1, _4>{}, Stride<_1, _0, Int<16 * 64>>{}));
    Element *Ptsmem_ptr_sts = reinterpret_cast<Element *>(sP.data().get()) + warp_id * 4 * 64 + row * 64 + 4 * col;
    Tensor tPtsPt =
        make_tensor(make_smem_ptr(Ptsmem_ptr_sts), make_layout(Shape<_4, _1, _4>{}, Stride<_1, _0, Int<16 * 64>>{}));
    ...
    Tensor tdKsdSt = make_tensor(make_smem_ptr(dStsmem_ptr_lds),
                                 make_layout(Shape<_4, _4, _4>{}, Stride<_1, Int<16 * 64>, Int<4 * 64>>{}));
...
#pragma unroll
    ...
    Tensor sdK = make_tensor(sK.data(), typename Kernel_traits::SmemLayoutdKV_hdim64{});
    Tensor sdV = make_tensor(sdK.data() + size(sdK), typename Kernel_traits::SmemLayoutdKV_hdim64{});
