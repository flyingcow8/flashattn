...
KERNEL_IMPL_TEMPLATE_FWD = """#include "flash_parameter.h"
#include "flash.h"
...
KERNEL_IMPL_TEMPLATE_FWD_SPLIT = """#include "flash_parameter.h"
#include "flash.h"
#include "flash_fwd_launch_template.h"
#include <mctlass/numeric_types.h>
...
KERNEL_IMPL_TEMPLATE_BWD = """#include "flash_parameter.h"
#include "flash.h"
...
class Kernel:
    ...
    def filename(self) -> str:
        return f"{self.direction}/flash_{self.direction}_hdim{self.head_dim}_{self.dtype}_{'causal_' if self.is_causal == 'true' else ''}sm{self.sm}.cu"
