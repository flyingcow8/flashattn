...
#define BOOL_SWITCH(COND, CONST_NAME, ...) BOOL_SWITCH_AND_CONST_PRECOND(true, COND, CONST_NAME, __VA_ARGS__)
...
#ifdef FLASHATTENTION_DISABLE_LOCAL
#define LOCAL_SWITCH(COND, CONST_NAME, ...) BOOL_SWITCH_AND_CONST_PRECOND(false, COND, CONST_NAME, __VA_ARGS__)
#else
