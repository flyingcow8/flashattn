...
def _flash_attn_forward(
    q, k, v, dropout_p, softmax_scale, causal, window_size, alibi_slopes, attn_mask, return_softmax
):
...
def _flash_attn_backward(
    ...
    dout, q, k, v, out, attn_mask = [maybe_contiguous(x) for x in (dout, q, k, v, out, attn_mask)]
...
class FlashAttnFunc(torch.autograd.Function):
    ...
    def backward(ctx, dout, *args):
        q, k, v, out, softmax_lse, rng_state = ctx.saved_tensors
        # [C500-24332] Fix sd1.5 training bwd nan
